...
func (u *CachedUserRepository) toDomainUser(usr dao.User) domain.User {
	return domain.User{
		...
		WeChatInfo: domain.WeChatInfo{
			OpenId:  usr.WechatOpenId.String,
			UnionId: usr.WechatUnionId.String,
		},
	}
}
...
func (u *CachedUserRepository) ToEntity(usr domain.User) dao.User {
	return dao.User{
		...
		WechatUnionId: sql.NullString{
			String: usr.WeChatInfo.UnionId,
			Valid:  usr.WeChatInfo.UnionId != "",
		},
		WechatOpenId: sql.NullString{
			String: usr.WeChatInfo.OpenId,
			Valid:  usr.WeChatInfo.OpenId != "",
		},
		Birthday: usr.Birthday,
		AboutMe:  usr.AboutMe,
	}
