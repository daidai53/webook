...
import (
	...
	dao "github.com/daidai53/webook/internal/repository/dao"
...
func (m *MockUserDAO) Update(ctx context.Context, idInt64 int64, user dao.User) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, idInt64, user)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockUserDAOMockRecorder) Update(ctx, idInt64, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockUserDAO)(nil).Update), ctx, idInt64, user)
}
