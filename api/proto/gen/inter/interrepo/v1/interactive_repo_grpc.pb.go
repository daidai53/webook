...
const (
	InteractiveRepository_IncrReadCnt_FullMethodName       = "/interrepo.v1.InteractiveRepository/IncrReadCnt"
	InteractiveRepository_BatchIncrReadCnt_FullMethodName  = "/interrepo.v1.InteractiveRepository/BatchIncrReadCnt"
	InteractiveRepository_IncrLike_FullMethodName          = "/interrepo.v1.InteractiveRepository/IncrLike"
	InteractiveRepository_DecrLike_FullMethodName          = "/interrepo.v1.InteractiveRepository/DecrLike"
	InteractiveRepository_AddCollectionItem_FullMethodName = "/interrepo.v1.InteractiveRepository/AddCollectionItem"
	InteractiveRepository_Get_FullMethodName               = "/interrepo.v1.InteractiveRepository/Get"
	InteractiveRepository_Liked_FullMethodName             = "/interrepo.v1.InteractiveRepository/Liked"
	InteractiveRepository_Collected_FullMethodName         = "/interrepo.v1.InteractiveRepository/Collected"
	InteractiveRepository_TopIds_FullMethodName            = "/interrepo.v1.InteractiveRepository/TopIds"
	InteractiveRepository_GetByIds_FullMethodName          = "/interrepo.v1.InteractiveRepository/GetByIds"
)
...
type InteractiveRepositoryClient interface {
	...
	TopIds(ctx context.Context, in *TopIdsRequest, opts ...grpc.CallOption) (*TopIdsResponse, error)
...
func (c *interactiveRepositoryClient) TopIds(ctx context.Context, in *TopIdsRequest, opts ...grpc.CallOption) (*TopIdsResponse, error) {
	out := new(TopIdsResponse)
	err := c.cc.Invoke(ctx, InteractiveRepository_TopIds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InteractiveRepositoryServer interface {
	...
	TopIds(context.Context, *TopIdsRequest) (*TopIdsResponse, error)
...
func (UnimplementedInteractiveRepositoryServer) TopIds(context.Context, *TopIdsRequest) (*TopIdsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TopIds not implemented")
}
...
func _InteractiveRepository_TopIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TopIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveRepositoryServer).TopIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveRepository_TopIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveRepositoryServer).TopIds(ctx, req.(*TopIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InteractiveRepository_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "interrepo.v1.InteractiveRepository",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TopIds",
			Handler:    _InteractiveRepository_TopIds_Handler,
		},
		{
			MethodName: "GetByIds",
	...
	Metadata: "inter/interrepo/v1/interactive_repo.proto",
}
